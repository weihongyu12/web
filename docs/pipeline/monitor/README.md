...
- 遵守 PIPL、GDPR、CCPA 等数据保护法规
- 明确告知用户数据收集的范围和用途
- 避免收集敏感个人信息
- 实现数据脱敏措施

:::danger
《个人信息保护法》要求，向境外提供个人信息需通过安全评估、签订标准合同或获得专业机构认证。
由于 Sentry、LogRocket和Google Analytics 均存储于境外服务器，在使用时请遵循相关法律法规。或者使用境内服务商的替代方案，如：腾讯云、阿里云等。
:::
