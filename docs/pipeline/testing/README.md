...
- **[MSW (Mock Service Worker)](https://mswjs.io/)**：拦截网络请求进行 API 模拟
- **[Jest](https://jestjs.io/zh-Hans/) + [React Testing Library](https://testing-library.com/docs/react-testing-library/intro/)**：测试 React 组件树
- **[Vitest](https://cn.vitest.dev/) + [Vue Test Utils](https://test-utils.vuejs.org/zh/)**：测试 Vue 组件集成
